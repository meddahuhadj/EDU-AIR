...
COMMANDS: list[dict] = [
    ...
    {"intent": SCROLL_DOWN, "langs": ["fr"],
     "patterns": [r"\b(?:d[ée]file|fais\s+d[ée]filer).{0,4}bas",
                  r"\bdescend(?:s|re)?\s+(?:la\s+)?page\b",
                  r"\bva\s+(?:vers\s+le\s+)?bas\b"]},
    ...
    {"intent": SCROLL_UP, "langs": ["fr"],
     "patterns": [r"\b(?:d[ée]file|fais\s+d[ée]filer).{0,4}haut",
                  r"\bmonte(?:r)?\s+(?:la\s+)?page\b",
                  r"\bva\s+(?:vers\s+le\s+)?haut\b"]},
