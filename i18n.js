...
var DICT = {
  ...
  ar:{
    ...
    "calib.guidePlace":"أظهر يدك، ثم المس كل زاوية مضيئة بسبابتك","calib.guideTap":"أبقِ سبابتك على الزاوية {n}","calib.guideHand":"لم يتم رصد يد — أظهر يدك","calib.guideOrClick":"(أو انقر على الزاوية)","calib.doneText":"اكتملت المعايرة — راجع النتيجة أعلاه","calib.sweetSpot":"المنطقة المثالية — أبقِ يدك داخلها أثناء التأشير",
    "history.title":"السجل","history.lede":"كل خط، كل اختبار، كل جلسة — سجلّك المحلي.",
    "settings.title":"الإعدادات","settings.lang":"اللغة","settings.sensitivity":"حساسية المؤشر","settings.stability":"ثبات المؤشر (مضاد للاهتزاز)","settings.confidence":"عتبة الثقة في الإيماءات","settings.primHand":"اليد الرئيسية","settings.a11y":"إمكانية الوصول","settings.a11yMotion":"تقليل الحركة","settings.a11yContrast":"تباين عالٍ","settings.a11yCursor":"مؤشر كبير","settings.install":"تثبيت التطبيق","settings.reset":"إعادة ضبط البيانات المحلية",
