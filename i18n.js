...
var DICT = {
  en:{
    ...
    "gam.first":"First quiz","gam.perfect":"Perfect score!","gam.marathon":"10 quizzes done","gam.sharp":"+75% accuracy","conf.reload":"Detection model reloaded",
  ...
  fr:{
    ...
    "settings.title":"Réglages","settings.lang":"Langue","settings.sensitivity":"Sensibilité du pointeur","settings.confidence":"Seuil de confiance gestes","settings.a11y":"Accessibilité","settings.a11yMotion":"Réduire les animations","settings.a11yContrast":"Contraste élevé","settings.a11yCursor":"Grand curseur","settings.install":"Installer l'application","settings.reset":"Réinitialiser les données locales",
    ...
    "gam.first":"Premier quiz","gam.perfect":"Score parfait !","gam.marathon":"10 quiz terminés","gam.sharp":"+75 % de réussite","conf.reload":"Modèle de détection rechargé",
  ...
  ar:{
    ...
    "settings.title":"الإعدادات","settings.lang":"اللغة","settings.sensitivity":"حساسية المؤشر","settings.confidence":"عتبة الثقة في الإيماءات","settings.a11y":"إمكانية الوصول","settings.a11yMotion":"تقليل الحركة","settings.a11yContrast":"تباين عالٍ","settings.a11yCursor":"مؤشر كبير","settings.install":"تثبيت التطبيق","settings.reset":"إعادة ضبط البيانات المحلية",
    ...
    "gam.first":"أول اختبار","gam.perfect":"درجة مثالية!","gam.marathon":"10 اختبارات مكتملة","gam.sharp":"دقة +75%","conf.reload":"أُعيد تحميل نموذج الكشف",
  ...
  nl:{
    ...
    "gam.first":"Eerste quiz","gam.perfect":"Perfecte score!","gam.marathon":"10 quizzes afgerond","gam.sharp":"+75% nauwkeurigheid","conf.reload":"Detectiemodel herladen",
