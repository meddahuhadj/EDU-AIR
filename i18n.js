...
var DICT = {
  en:{
    ...
    "calib.guidePlace":"Show your hand, then touch each highlighted corner with your index finger","calib.guideTap":"Hold your index finger on corner {n}","calib.guideHand":"No hand detected — show your hand","calib.guideOrClick":"(or click the corner)","calib.doneText":"Calibration complete — see your score above",
    "history.title":"History","history.lede":"Every stroke, every quiz, every session — your local audit trail.",
    "settings.title":"Settings","settings.lang":"Language","settings.sensitivity":"Pointer sensitivity","settings.confidence":"Gesture detection confidence","settings.primHand":"Primary hand","settings.a11y":"Accessibility","settings.a11yMotion":"Reduce motion","settings.a11yContrast":"High contrast","settings.a11yCursor":"Large cursor","settings.install":"Install app","settings.reset":"Reset all local data",
  ...
  fr:{
    ...
    "calib.guidePlace":"Montrez votre main, puis touchez chaque coin en surbrillance avec votre index","calib.guideTap":"Maintenez votre index sur le coin {n}","calib.guideHand":"Aucune main détectée — montrez votre main","calib.guideOrClick":"(ou cliquez sur le coin)","calib.doneText":"Calibrage terminé — voir votre score ci-dessus",
    "history.title":"Historique","history.lede":"Chaque trait, chaque quiz, chaque session — votre journal local.",
    "settings.title":"Réglages","settings.lang":"Langue","settings.sensitivity":"Sensibilité du pointeur","settings.confidence":"Seuil de confiance gestes","settings.primHand":"Main principale","settings.a11y":"Accessibilité","settings.a11yMotion":"Réduire les animations","settings.a11yContrast":"Contraste élevé","settings.a11yCursor":"Grand curseur","settings.install":"Installer l'application","settings.reset":"Réinitialiser les données locales",
  ...
  ar:{
    ...
    "calib.guidePlace":"أظهر يدك، ثم المس كل زاوية مضيئة بسبابتك","calib.guideTap":"أبقِ سبابتك على الزاوية {n}","calib.guideHand":"لم يتم رصد يد — أظهر يدك","calib.guideOrClick":"(أو انقر على الزاوية)","calib.doneText":"اكتملت المعايرة — راجع النتيجة أعلاه",
    "history.title":"السجل","history.lede":"كل خط، كل اختبار، كل جلسة — سجلّك المحلي.",
    "settings.title":"الإعدادات","settings.lang":"اللغة","settings.sensitivity":"حساسية المؤشر","settings.confidence":"عتبة الثقة في الإيماءات","settings.primHand":"اليد الرئيسية","settings.a11y":"إمكانية الوصول","settings.a11yMotion":"تقليل الحركة","settings.a11yContrast":"تباين عالٍ","settings.a11yCursor":"مؤشر كبير","settings.install":"تثبيت التطبيق","settings.reset":"إعادة ضبط البيانات المحلية",
  ...
  nl:{
    ...
    "calib.guidePlace":"Toon uw hand en raak daarna elke heldere hoek aan met uw wijsvinger","calib.guideTap":"Houd uw wijsvinger op hoek {n}","calib.guideHand":"Geen hand gedetecteerd — toon uw hand","calib.guideOrClick":"(of klik op de hoek)","calib.doneText":"Kalibratie voltooid — zie uw score hierboven",
    "history.title":"Geschiedenis","history.lede":"Elke streek, elke quiz, elke sessie — uw lokale logboek.",
    "settings.title":"Instellingen","settings.lang":"Taal","settings.sensitivity":"Aanwijzergevoeligheid","settings.confidence":"Gebaardetectie-vertrouwen","settings.primHand":"Primaire hand","settings.a11y":"Toegankelijkheid","settings.a11yMotion":"Beweging beperken","settings.a11yContrast":"Hoog contrast","settings.a11yCursor":"Grote cursor","settings.install":"App installeren","settings.reset":"Lokale gegevens resetten",
