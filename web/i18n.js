...
window.hadjI18n = (() => {
  ...
  const STR = {
    ...
    en: {
      ...
      "nav.compare": "vs TNI",
      "compare.eyebrow": "vs · Interactive whiteboard",
      "compare.title": 'EDU-AIR — the classroom edition of HADJ NO-TOUCH AI — <span class="grad-text">beats the touch screen.</span>',
      "compare.lede": "Same room, same projector — without buying a tactile board or installing one.",
      "compare.caption": "Comparison between a classic interactive whiteboard and EDU-AIR",
      "compare.h0": "Criterion",
      "compare.h1": "Interactive whiteboard (TNI)",
      "compare.h2": "EDU-AIR",
      "compare.r1c": "Interaction",
      "compare.r1a": "Stylus / finger on a dedicated touch surface",
      "compare.r1b": "Gestures in the air, voice, gaze — nothing is touched",
      "compare.r2c": "Surface",
      "compare.r2a": "Dedicated touch screen required",
      "compare.r2b": "Any surface: wall, projector, existing screen",
      "compare.r3c": "Hardware",
      "compare.r3a": "Board + proprietary software + wiring",
      "compare.r3b": "A computer + webcam already in the room",
      "compare.r4c": "Hygiene",
      "compare.r4a": "Constant contact, shared surface to disinfect",
      "compare.r4b": "Zero contact, natural distancing",
      "compare.r5c": "Deployment",
      "compare.r5a": "Heavy install, sometimes building work",
      "compare.r5b": "Unzip and run, or PWA — immediate",
      "compare.r6c": "Cost",
      "compare.r6a": "Costly screen + maintenance + licences",
      "compare.r6b": "Software cost, amortised on what you already own",
      "compare.note": "In one line: the TNI makes the screen touchable; EDU-AIR makes the air interactive — on the equipment you already have.",
    ...
    fr: {
      ...
      "nav.compare": "vs TNI",
      "compare.eyebrow": "vs · Tableau interactif",
      "compare.title": 'EDU-AIR — l’édition classe de HADJ NO-TOUCH AI — <span class="grad-text">remplace l’écran tactile.</span>',
      "compare.lede": "La même salle, le même projecteur — sans acheter de tableau tactile ni l’installer.",
      "compare.caption": "Comparaison entre un tableau blanc interactif classique et EDU-AIR",
      "compare.h0": "Critère",
      "compare.h1": "Tableau blanc interactif (TNI)",
      "compare.h2": "EDU-AIR",
      "compare.r1c": "Interaction",
      "compare.r1a": "Stylet / doigt sur une surface tactile dédiée",
      "compare.r1b": "Gestes dans l’air, voix, regard — rien n’est touché",
      "compare.r2c": "Surface",
      "compare.r2a": "Écran tactile dédié obligatoire",
      "compare.r2b": "N’importe quelle surface : mur, projecteur, écran existant",
      "compare.r3c": "Matériel",
      "compare.r3a": "Tableau + logiciel propriétaire + câblage",
      "compare.r3b": "Un ordinateur + une webcam déjà présents",
      "compare.r4c": "Hygiène",
      "compare.r4a": "Contact permanent, surface partagée à désinfecter",
      "compare.r4b": "Zéro contact, distanciation naturelle",
      "compare.r5c": "Déploiement",
      "compare.r5a": "Installation lourde, parfois des travaux",
      "compare.r5b": "Dézipper et lancer, ou PWA — immédiat",
      "compare.r6c": "Coût",
      "compare.r6a": "Écran coûteux + maintenance + licences",
      "compare.r6b": "Coût logiciel, amorti sur l’existant",
      "compare.note": "En une ligne : le TNI rend l’écran tactile ; EDU-AIR rend l’air interactif — sur l’équipement déjà présent.",
    ...
    ar: {
      ...
      "nav.compare": "مقارنة TNI",
      "compare.eyebrow": "vs · السبورة التفاعلية",
      "compare.title": 'EDU-AIR — إصدار الفصل من HADJ NO-TOUCH AI — <span class="grad-text">يتفوق على الشاشة اللمسية.</span>',
      "compare.lede": "نفس القاعة، نفس جهاز العرض — دون شراء سبورة لمسية أو تركيب واحدة.",
      "compare.caption": "مقارنة بين سبورة تفاعلية كلاسيكية وEDU-AIR",
      "compare.h0": "المعيار",
      "compare.h1": "السبورة التفاعلية (TNI)",
      "compare.h2": "EDU-AIR",
      "compare.r1c": "التفاعل",
      "compare.r1a": "قلم / إصبع على سطح لمسي مخصص",
      "compare.r1b": "إيماءات في الهواء، صوت، نظر — لا يُلمس شيء",
      "compare.r2c": "السطح",
      "compare.r2a": "شاشة لمسية مخصصة إلزامية",
      "compare.r2b": "أي سطح: جدار، جهاز عرض، شاشة موجودة",
      "compare.r3c": "العتاد",
      "compare.r3a": "سبورة + برنامج مملوك + توصيلات",
      "compare.r3b": "حاسوب + كاميرا ويب موجودة بالفعل",
      "compare.r4c": "النظافة",
      "compare.r4a": "لمس مستمر، سطح مشترك يلزم تطهيره",
      "compare.r4b": "صفر لمس، تباعد طبيعي",
      "compare.r5c": "النشر",
      "compare.r5a": "تركيب ثقيل، أحيانًا أعمال بناء",
      "compare.r5b": "فك الضغط وتشغيل، أو PWA — فوري",
      "compare.r6c": "التكلفة",
      "compare.r6a": "شاشة مكلفة + صيانة + تراخيص",
      "compare.r6b": "تكلفة البرنامج، مُطفأة على ما هو متوفر",
      "compare.note": "بسطر واحد: السبورة التفاعلية تجعل الشاشة قابلة للمس؛ EDU-AIR يجعل الهواء تفاعليًا — على المعدات التي تمتلكها.",
    ...
    nl: {
      ...
      "nav.compare": "vs TNI",
      "compare.eyebrow": "vs · Interactief bord",
      "compare.title": 'EDU-AIR — de klas-editie van HADJ NO-TOUCH AI — <span class="grad-text">wint van het touchscreen.</span>',
      "compare.lede": "Zelfde lokaal, zelfde projector — zonder een interactief bord te kopen of te installeren.",
      "compare.caption": "Vergelijking tussen een klassiek interactief whiteboard en EDU-AIR",
      "compare.h0": "Criterium",
      "compare.h1": "Interactief whiteboard (TNI)",
      "compare.h2": "EDU-AIR",
      "compare.r1c": "Interactie",
      "compare.r1a": "Pen / vinger op een toegewijd aanraakoppervlak",
      "compare.r1b": "Gebaren in de lucht, spraak, blik — niets wordt aangeraakt",
      "compare.r2c": "Oppervlak",
      "compare.r2a": "Toegewijd aanraakscherm verplicht",
      "compare.r2b": "Elk oppervlak: muur, projector, bestaand scherm",
      "compare.r3c": "Hardware",
      "compare.r3a": "Bord + propriëtaire software + bekabeling",
      "compare.r3b": "Een computer + webcam die er al zijn",
      "compare.r4c": "Hygiëne",
      "compare.r4a": "Constant contact, gedeeld oppervlak om te ontsmetten",
      "compare.r4b": "Geen contact, natuurlijke afstand",
      "compare.r5c": "Implementatie",
      "compare.r5a": "Zware installatie, soms bouwwerkzaamheden",
      "compare.r5b": "Uitpakken en starten, of PWA — direct",
      "compare.r6c": "Kosten",
      "compare.r6a": "Duur scherm + onderhoud + licenties",
      "compare.r6b": "Softwarekosten, afgeschreven op wat er al is",
      "compare.note": "In één zin: de TNI maakt het scherm aanraakbaar; EDU-AIR maakt de lucht interactief — op de apparatuur die je al hebt.",
